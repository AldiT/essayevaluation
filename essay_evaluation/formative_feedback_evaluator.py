...
class FormativeFeedbackEvaluator(object):
    ...
    def __call__(self, feature_matrix, level, num_of_tokens):
        """
    ...
    def get_feedback(self):
        ...
        for index in range(len(self.bin_data)):
            ...
            #neutral for values that there is no data for
            if self.bin_data[index]["mean"] == 0 and self.bin_data[index]["std"] == 0:
                result[-1] = 0
